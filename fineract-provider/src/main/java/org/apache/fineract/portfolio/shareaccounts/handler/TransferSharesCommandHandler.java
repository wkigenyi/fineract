...
@Service
@CommandType(entity = "SHAREACCOUNT", action = "TRANSFERSHARES")
@RequiredArgsConstructor
public class TransferSharesCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand jsonCommand) {
        return this.shareAccountWritePlatformService.transferShares(jsonCommand.entityId(), jsonCommand);
    }
}
